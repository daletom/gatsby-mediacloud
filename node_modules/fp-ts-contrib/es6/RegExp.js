 ...
 * @since 0.1.8
 */
export var match = function (r) { return function (s) { return O.fromNullable(s.match(r)); }; };
/**
 ...
 * @since 0.1.8
 */
export var test = function (r) { return function (s) { return r.test(s); }; };
/**
 ...
 * @since 0.1.8
 */
export var sub = function (r, replacement) { return function (s) {
 ...
 * @since 0.1.8
 */
export var split = function (r) { return function (s) { return s.split(r); }; };
